...
public class Item
{
    ...
    public static void registerItems()
    {
        ...
        for(Block block : Client.get().getBlockManager().getBlocks()){
        ...
        Client.get().onItemRegister(REGISTRY);
    ...
    public static enum ToolMaterial
    {
        ...
        DRAKIUM(3, 1561, 8.0F, 3.0F, 10),
        DRAGONITE(3, 1561, 8.0F, 3.0F, 10),
        URANITE(3, 1561, 8.0F, 3.0F, 10),
        AMETHYSTE(3, 1561, 8.0F, 3.0F, 10),
        ;
        ...
        public Item getRepairItem()
        {
            ...
            else if (this == TOURMALINE)
            {
                return Client.get().getItemManager().getItem("tourmaline");
            }
            else if (this == DRAKIUM)
            {
                return Client.get().getItemManager().getItem("drakium");
            }
            else if (this == DRAGONITE)
            {
                return Client.get().getItemManager().getItem("dragonite");
            }
            else if (this == URANITE)
            {
                return Client.get().getItemManager().getItem("uranite");
            }
            else if (this == AMETHYSTE)
            {
                return Client.get().getItemManager().getItem("amethyste");
            }
            else
            {
