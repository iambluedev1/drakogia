...
public class ItemTool extends Item
{
    ...
    public ItemTool(float attackDamageIn, float attackSpeedIn, Item.ToolMaterial materialIn, Set<Block> effectiveBlocksIn)
    {
    ...
    public ItemTool(Item.ToolMaterial materialIn, Set<Block> effectiveBlocksIn)
    {
