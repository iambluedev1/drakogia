...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleChat(SPacketChat packetIn)
    {
    	...
    	// Si il s'agit d'une info
    	if (unformattedText.startsWith("[+]") || unformattedText.startsWith("[-]")) {
    		
    		// On l'affiche en tant que tel
    		this.gameController.ingameGUI.addJoinOrLeaveMessage(chatComponent.getFormattedText());
