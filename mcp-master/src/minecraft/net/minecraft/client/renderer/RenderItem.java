...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    private void registerItems()
    {
        ...
        for(String block : Client.get().getBlockManager().getNames()){
        	this.registerBlock(Client.get().getBlockManager().getBlock(block), block);
        }
        ...
        for(String item : Client.get().getItemManager().getNames()){
        	this.registerItem(Client.get().getItemManager().getItem(item), item);
        }
    }
