...
public class GuiInventory extends InventoryEffectRenderer implements IRecipeShownListener
{
    ...
    public void initGui()
    {
        ...
        int xOffset = RecipeBook.field_192818_b ? 80 : 0;
        
        int x1 = (width + 180) / 2 + xOffset;
        int y1 = (height - 74) / 2 - 25;
        int x2 = (width + 180) / 2 + xOffset;
        int y2 = (height - 74) / 2 - 4;
        int x3 = (width + 180) / 2 + xOffset;
        int y3 = (height - 74) / 2 + 17;
        int x4 = (width + 180) / 2 + xOffset;
        int y4 = (height - 74) / 2 + 38;
        int x5 = (width + 180) / 2 + xOffset;
        int y5 = (height - 74) / 2 + 59;
        int x6 = (width + 180) / 2 + xOffset;
        int y6 = (height - 74) / 2 + 80;
                
        //Boutons
        this.buttonList.add(new GuiButton(0, x1, y1, 60, 20, "§bEvents"));
        this.buttonList.add(new GuiButton(1, x2, y2, 60, 20, "§eQuêtes"));
        this.buttonList.add(new GuiButton(2, x3, y3, 60, 20, "§dWiki"));
        this.buttonList.add(new GuiButton(3, x4, y4, 60, 20, "§6Shop"));
        this.buttonList.add(new GuiButton(4, x5, y5, 60, 20, "§fAiles"));
        this.buttonList.add(new GuiButton(5, x6, y6, 60, 20, "§cPoubelle"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if (button.id == 2)
        {
        	//this.mc.displayGuiScreen(new GuiWiki(this.mc.player));
        }
        
        if (button.id == 3)
        {
        	this.mc.player.sendChatMessage("/shop");
        }
        
        if (button.id == 5)
        {
        	this.mc.player.sendChatMessage("/poubelle");
        }  
    }
